...
public class ORDSTestsDay4 {
    ...
    public void getEmployeeTest(){
        ...
        System.out.println("Worst employee: "+poorGuy);
        System.out.println("Company budget: "+ companiesPayroll);
    ...
    public void verifyPhoneNumber() {
        ...
        Response response=when().get("/employees/{id}",101);

//        response.then().assertThat().statusCode(200).and().body("phone_number",is("515.123.4568"));
